package br.com.telas;
	/**
	 * Consultar Funcionários Excluídos
	 */
	...
	public class ConsultaFuncionariosInativos extends JFrame implements KeyListener, ActionListener {
		...
		public ConsultaFuncionariosInativos() throws DaoException {
			setResizable(false);
	        ...
	        txtPesq.setColumns(10);
	                    ...
	                    JLabel lblFuncionriosInativos = new JLabel("Funcion\u00E1rios Exclu\u00EDdos");
	                    lblFuncionriosInativos.setFont(new Font("Kalinga", Font.BOLD, 16));
	                    lblFuncionriosInativos.setHorizontalAlignment(SwingConstants.CENTER);
	                    lblFuncionriosInativos.setBackground(Color.WHITE);
	                    lblFuncionriosInativos.setBounds(10, 11, 612, 29);
	                    lista.add(lblFuncionriosInativos);
				...
				public void mouseClicked(MouseEvent arg0) {
					...
					if(coluna == 4){
						int opcao;
						opcao = JOptionPane.showConfirmDialog(null,"Deseja ativar o funcionário de número: "+ matricula ,"Cuidado!!",JOptionPane.YES_NO_OPTION);				
						   if(opcao == JOptionPane.YES_OPTION){  
							   try {
								funcDao.ativarFuncionarios(mat);
								atualizaLista(table,"");
...
//											String cripta;
		...
		public void atualizaLista(JTable lista, String nome) throws DaoException{
			...
			renderer1.setToolTipText("Ativar novamente o funcionário");
			columnModel.getColumn(4).setCellRenderer(renderer1);

	        dtm.setRowCount(0); 
			List<Funcionario> listaFunc  = new ArrayList<Funcionario>();
	 		listaFunc = funcDao.consultarFuncionariosInativos(nome);
