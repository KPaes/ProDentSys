...
public class SplashScreen extends JWindow {
	...
	public SplashScreen() {
		...
		lblNewLabel.setIcon(new ImageIcon(SplashScreen.class.getResource("/br/com/images/java.png")));
		...
		JLabel lblKbyteCopyrights = new JLabel("All Rights Reserved KByte\u00A9 2013");
		lblKbyteCopyrights.setFont(new Font("Verdana", Font.BOLD, 10));
		lblKbyteCopyrights.setBounds(155, 180, 194, 19);
		panel.add(lblKbyteCopyrights);
	}
