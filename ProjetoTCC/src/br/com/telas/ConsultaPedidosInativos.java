...
public class ConsultaPedidosInativos extends JFrame implements KeyListener {
	 final static JPanel lista = new JPanel();
		...
		private static JTextField textDent;
		private static JTextField textTotalPed;
		private JTextField textField_5;
		private static JTextField textProtetico;
		private static JTextField txtNumFunc;
		private static JTextField txtNumCliente;
		...
		private static JTextField textProteses;
		private static JTextField textTipos;
	    ...
	    private static JTextField textValorProt;  
	    private JTextField textValorServ;  
	    private JTextField textTotal;  	     	    
	    private static ProtesesTableModel tableModel;  
       ...
       // MouseListener tableMouseListener = null;
		...
		public ConsultaPedidosInativos() throws DaoException {
	       ...
	       // setModal(true);
	        ...
	        txtPesq.setPrompt("Nome do dentista");
	        txtPesq.setToolTipText("Digite o nome do dentista");
	        txtPesq.setBounds(10, 75, 132, 20);
	        ...
	        txtPesq.setColumns(10);
	        	        	        ...
	        	        	        formulario.add(panel);
	        	        	                  ...
	        	        	                  JMenuItem mntmCliente = new JMenuItem("Pesquisar Cliente");
	        	        	                  mntmCliente.setIcon(new ImageIcon(Ped.class.getResource("/br/com/images/search.png")));
	        	        	                  mntmCliente.addActionListener(new ActionListener() {
	        	        	                  	public void actionPerformed(ActionEvent e) {
	        	        	                  		new ViewSelecionaCliente(1);
	        	        	                  	}
	        	        	                  });
	        	        	                  popupMenu.add(mntmCliente);
	        	        	                  
	        	        	                  JMenuItem mntmProtetico = new JMenuItem("Pesquisar Prot\u00E9tico");
	        	        	                  mntmProtetico.setIcon(new ImageIcon(Ped.class.getResource("/br/com/images/search.png")));
	        	        	                  mntmProtetico.addActionListener(new ActionListener() {
	        	        	                  	public void actionPerformed(ActionEvent e) {
	        	        	                  		new ViewSelecionaFuncionario(2);
	        	        	                  	}
	        	        	                  });
	        	        	                  popupMenu.add(mntmProtetico);
						...
						public void actionPerformed(ActionEvent arg0) {
							...
							SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
									...
									Date data1 = dtDataPedido.getDate();
									Date data2 = dtDataEntrega.getDate();
									if(CalcularData.TirarDiferenca(data1, data2) < 0){
										...
										try {
											obj.setDataPedido(df.parse(dtDataPedido.getEditor().getText()));
								...
								obj.setNomeFunc(textProtetico.getText());
								obj.setNumFunc(Integer.parseInt(txtNumFunc.getText()));
								obj.setNomeCliente(textDent.getText());
								obj.setNumCliente(Integer.parseInt(txtNumCliente.getText()));
						...
						public void actionPerformed(ActionEvent e) {
							limpaFormulario();
	        	        	                   ...
	        	        	                   textDent = new JTextField();
	        	        	                   textDent.setBounds(326, 31, 222, 20);
	        	        	                   panel.add(textDent);
	        	        	                   textDent.setColumns(10);
...
//	        	        	                   textField_2.setColumns(10);
	        	        	                ...
	        	        	                //   textTotalPed = new JFormattedTextField(MascaraUtil.setMascara("R$###.##"));
	        	        	                   ...
	        	        	                   textTotalPed.setColumns(10);
	        	        	                     ...
	        	        	                     txtNumFunc.setToolTipText("Ou clique com o bot\u00E3o direito fora do campo do preenchimento");
	        	        	                     txtNumFunc.setBounds(128, 269, 70, 20); 
	        	        	                     panel.add(txtNumFunc);
	        	        	                     txtNumFunc.setColumns(10);
	        	        	                     
	        	        	                     txtNumCliente = new JTextField();
	        	        	                     txtNumCliente.setToolTipText("Ou clique com o bot\u00E3o direito fora do campo do preenchimento");
	        	        	                     txtNumCliente.setBounds(128, 31, 70, 20); 
...
//	        	        	             		 dtDataEntrega.setName("Data de nascimento. Campo ObrigatÃ³rio.");
	        	        	                     ...
	        	        	                     btnOk.addActionListener(new ActionListener() {
	        	        	                     	public void actionPerformed(ActionEvent arg0) {
	        	        	                     		String aux = txtNumCliente.getText();
	        	        	                     		if(txtNumCliente.getText().equals("")){
	        	        	            					JOptionPane.showMessageDialog(null, "Digite um número!");
		        	        	                     		...
		        	        	                     		chamaCliente(Integer.parseInt(txtNumCliente.getText()));
	        	                                  		}else{
	        	        	                     ...
	        	        	                     btnOk_1.addActionListener(new ActionListener() {
	        	        	                     	public void actionPerformed(ActionEvent e) {
	        	        	                     		String aux = txtNumFunc.getText();
	        	        	                     		if(txtNumFunc.getText().equals("")){
	        	        	            					JOptionPane.showMessageDialog(null, "Digite um número!");
	        	        	            				}else if(aux.matches("^[0-9]*$")){
	        	        	                     			//chamar o método para pesquisar atraves do número do funcionário	                   		 
	        	        	                     			chamaFuncionario(Integer.parseInt(txtNumFunc.getText()));
	        	                                  		}else{
	        	                                  			JOptionPane.showMessageDialog(null, "Digite apenas número!");
	        	                                  		}
	        	        	                     ...
	        	        	                     textProtetico = new JTextField();
	        	        	                     textProtetico.setBounds(400, 269, 148, 20);
	        	        	                     panel.add(textProtetico);
	        	        	                     textProtetico.setColumns(10);
...
//	        	        	                     		try {
//	        	        	                     			ViewSelecionaProtese car =	new ViewSelecionaProtese(1);
//															car.setVisible(true);
...
//	        	        	                     		carrinho.setVisible(false);
		...
		public void atualizaFormulario(Pedido objPedido){
			...
			textProtetico.setText(objPedido.getNomeFunc()); 
			txtNumFunc.setText(String.valueOf(objPedido.getNumFunc()));
			
			txtNumCliente.setText(String.valueOf(objPedido.getNumCliente()));
			textDent.setText(objPedido.getNomeCliente());
		 ...
		 * @param numero
		 */
		static void chamaCliente(int idCliente) {
			...
			textDent.setText(objCliente.getNomeCliente());
			textDent.setEnabled(false);
			textField_cpf.setText(objCliente.getCpfCliente());

		}
		static void chamaFuncionario(int idFunc) {
			...
			txtNumFunc.setText(String.valueOf(idFunc));
			textProtetico.setText(objFunc.getNomeFunc());
			textProtetico.setEnabled(false);
		}
		
		public static void pegaTotalPedido(String pegaTotal, JTextField textTotal){
		...
		public static void atualizaFormularioProt(String pegaTotal, String mensagem){
